...
import com.ram.fastnewsspringmysql.repository.PostRepository;
...
public class PostServiceImpl implements PostService {
    ...
    @Override
    public Page<Post> searchPostsByKeywordAndCategoryAndTagAndAuthorId(String keyword, boolean active, boolean deleted, Long authorId, String categoryName, String tagName, Pageable pageable) {

        Page<Post> postsPage=postRepository.searchPostsByKeywordAndCategoryAndTagAndAuthorId(keyword,active,deleted,authorId,categoryName,tagName,pageable);
        return postsPage;
    }

//    @Override
//    public Page<Post> search(Long authorId, String title, String subtitle, String categoryName, Long tagId, List<String> fields, Pageable pageable) {
//
//
...
//
//    @Override
//    public Page<Post> searchByAdmin(Long authorId, String title, String subtitle, String categoryName, Long tagId, List<String> fields, Pageable pageable) {
//
//
//        //CREATING QUERY AND ADDING PAGEABLE TO IT
//        Query query = new Query().with(pageable);
...
//
    ...
    @Override
    public Optional<Post> getSinglePostByIdAndAuthorId(Long id, Long authorId) {
        return postRepository.findByPostIdAndAuthor_UserId(id, authorId);
    }

    @Override
    public void permanentlyDeletePostById(Long id) {
        postRepository.deleteById(id);
    }

//    @Override
//    public void permanentlyDeletePostByIdAndAuthorId(Long id, Long authorId) {
//        postRepository.DeleteByIdAndAuthorId(id,authorId);
//    }
//
//    @Override
//    public void permanentlyDeleteAllByAuthorId(Long authorId) {
...
//    }
    ...
    @Override
    public void permanentlyDeletePost(Long id) {
        postRepository.deleteById(id);
    }
    ...
    @Override
    public Optional<Post> getPostByIdAndActiveAndDeleted(Long id, boolean active, boolean deleted) {
        return postRepository.findByPostIdAndActiveAndDeleted(id,active,deleted);
    }
